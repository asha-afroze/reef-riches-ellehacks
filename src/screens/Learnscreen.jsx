...
const lessonContent = {
    saving: {
        1: {
            ...
            videoUrl: "/src/assets/videos/saving.mp4", // Replace with actual video URL
        },
        2: {
            ...
            videoUrl: "/src/assets/videos/saving.mp4",
        },
        3: {
            ...
            <div className='learn-content'>
                ...
                {lesson.videoUrl && (
                    <div className='video-section'>
                        <h3 className='video-header'>🎬 Cartoon Video Topic Explanation!</h3>
                        <a 
                ...
                <div className='learn-fish'>
                    <img src="/src/assets/orangefishy3.jpg" alt="Fish" />
                </div>
